    ...
    mod promote_to_bishop {
        ...
        fn it_promotes_the_pawn_to_the_bishop() {
            expectation()
                ...
                .to(|board| {
                    let bishop = Rc::clone(board.find_piece_by_id(&Color::White, &PieceId(2)).unwrap());
                    match *bishop {
                        Piece::Bishop(_) => (),
        ...
        fn it_calculates_moves_of_promoted_piece_properly() {
            ...
            let bishop = board.find_piece_by_id(&Color::White, &PieceId(2)).unwrap();
            println!("{}", board.pp());
            compare_and_assert(
    ...
    mod promote_to_knight {
        ...
        fn it_promotes_the_pawn_to_the_knight() {
            expectation()
                .to_change(|board| board.to_vec().clone_pieces())
                .to(|board| {
                    let knight = Rc::clone(board.find_piece_by_id(&Color::White, &PieceId(2)).unwrap());
                    match *knight {
                        Piece::Knight(_) => (),
        ...
        fn it_calculates_moves_of_promoted_piece_properly() {
            let board = expectation::<usize>().run_expectation();
            let knight = board.find_piece_by_id(&Color::White, &PieceId(2)).unwrap();
            println!("{}", board.pp());
            compare_and_assert(
    ...
    mod promote_to_queen {
        ...
        fn it_promotes_the_pawn_to_the_queen() {
            expectation()
                .to_change(|board| board.to_vec().clone_pieces())
                .to(|board| {
                    let queen = Rc::clone(board.find_piece_by_id(&Color::White, &PieceId(2)).unwrap());
                    match *queen {
                        Piece::Queen(_) => (),
        ...
        fn it_calculates_moves_of_promoted_piece_properly() {
            let board = expectation::<usize>().run_expectation();
            let queen = board.find_piece_by_id(&Color::White, &PieceId(2)).unwrap();
            println!("{}", board.pp());
            compare_and_assert(
    ...
    mod promote_to_rook {
        ...
        fn it_promotes_the_pawn_to_the_rook() {
            expectation()
                .to_change(|board| board.to_vec().clone_pieces())
                .to(|board| {
                    let rook = Rc::clone(board.find_piece_by_id(&Color::White, &PieceId(2)).unwrap());
                    match *rook {
                        Piece::Rook(_) => (),
    ...
    mod promote_to_bishop {
        ...
        fn it_captures_enemy_piece_and_promotes_the_pawn_to_the_bishop() {
            expectation()
                .to_change(|board| board.to_vec().clone_pieces())
                .to(|board| {
                    let bishop = Rc::clone(board.find_piece_by_id(&Color::White, &PieceId(3)).unwrap());
                    match *bishop {
                        Piece::Bishop(_) => (),
                        _ => panic!("Promoted piece is not a bishop!"),
                    }
        ...
        fn it_calculates_moves_of_promoted_piece_properly() {
            let board = expectation::<usize>().run_expectation();
            let bishop = board.find_piece_by_id(&Color::White, &PieceId(3)).unwrap();
            println!("{}", board.pp());
            compare_and_assert(
                &board.moves_of(bishop).to_vec(),
                &vec![
    ...
    mod promote_to_knight {
        ...
        fn it_captures_enemy_piece_and_promotes_the_pawn_to_the_knight() {
            expectation()
                .to_change(|board| board.to_vec().clone_pieces())
                .to(|board| {
                    let knight = Rc::clone(board.find_piece_by_id(&Color::White, &PieceId(3)).unwrap());
                    match *knight {
                        Piece::Knight(_) => (),
                        _ => panic!("Promoted piece is not a knight!"),
                    }
        ...
        fn it_calculates_moves_of_promoted_piece_properly() {
            let board = expectation::<usize>().run_expectation();
            let knight = board.find_piece_by_id(&Color::White, &PieceId(3)).unwrap();
            println!("{}", board.pp());
            compare_and_assert(
                &board.moves_of(knight).to_vec(),
                &vec![
    ...
    mod promote_to_queen {
        ...
        fn it_captures_enemy_piece_and_promotes_the_pawn_to_the_queen() {
            expectation()
                .to_change(|board| board.to_vec().clone_pieces())
                .to(|board| {
                    let queen = Rc::clone(board.find_piece_by_id(&Color::White, &PieceId(3)).unwrap());
                    match *queen {
                        Piece::Queen(_) => (),
                        _ => panic!("Promoted piece is not a queen!"),
                    }
        ...
        fn it_calculates_moves_of_promoted_piece_properly() {
            let board = expectation::<usize>().run_expectation();
            let queen = board.find_piece_by_id(&Color::White, &PieceId(3)).unwrap();
            println!("{}", board.pp());
            compare_and_assert(
                &board.moves_of(queen).to_vec(),
                &vec![
    ...
    mod promote_to_rook {
        ...
        fn it_captures_enemy_piece_and_promotes_the_pawn_to_the_rook() {
            expectation()
                .to_change(|board| board.to_vec().clone_pieces())
                .to(|board| {
                    let rook = Rc::clone(board.find_piece_by_id(&Color::White, &PieceId(3)).unwrap());
                    match *rook {
                        Piece::Rook(_) => (),
                        _ => panic!("Promoted piece is not a rook!"),
                    }
        ...
        fn it_calculates_moves_of_promoted_piece_properly() {
            let board = expectation::<usize>().run_expectation();
            let rook = board.find_piece_by_id(&Color::White, &PieceId(3)).unwrap();
            println!("{}", board.pp());
            compare_and_assert(
                &board.moves_of(rook).to_vec(),
                &vec![
