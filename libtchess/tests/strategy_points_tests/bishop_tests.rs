...
use libtchess::segment::Segment;
use libtchess::utils::pretty_print::PrettyPrint;
use libtchess::vector::diagonal_vector::DiagonalVector;
...
fn when_there_are_no_pieces_around() {
    ...
    compare_and_assert(
        &board
            .strategy_segments()
            .piece_segments(&bishop)
            .to_vec(),
        &vec![
            &Segment::Attack(*bishop.current_position(), Point::new(1, 1), Vector::Diagonal(DiagonalVector::BottomLeft), *bishop.id()),
            &Segment::Attack(*bishop.current_position(), Point::new(5, 5), Vector::Diagonal(DiagonalVector::TopRight), *bishop.id()),
            &Segment::Attack(*bishop.current_position(), Point::new(5, 1), Vector::Diagonal(DiagonalVector::BottomRight), *bishop.id()),
            &Segment::Attack(*bishop.current_position(), Point::new(1, 5), Vector::Diagonal(DiagonalVector::TopLeft), *bishop.id()),
        ],
    );
}
...
fn when_there_is_a_an_enemy_pieces_on_the_way() {
    ...
    compare_and_assert(
        ...
        &vec![
            &Segment::Attack(*bishop.current_position(), Point::new(1, 1), Vector::Diagonal(DiagonalVector::BottomLeft), *bishop.id()),
            &Segment::Attack(*bishop.current_position(), Point::new(3, 3), Vector::Diagonal(DiagonalVector::TopRight), *bishop.id()),
            &Segment::Attack(*bishop.current_position(), Point::new(3, 1), Vector::Diagonal(DiagonalVector::BottomRight), *bishop.id()),
            &Segment::Attack(*bishop.current_position(), Point::new(1, 3), Vector::Diagonal(DiagonalVector::TopLeft), *bishop.id()),
        ],
    );
}
...
fn when_there_is_an_ally_piece_on_the_way() {
    ...
    compare_and_assert(
        ...
        &vec![
            &Segment::Attack(*bishop.current_position(), Point::new(1, 1), Vector::Diagonal(DiagonalVector::BottomLeft), *bishop.id()),
            &Segment::Defense(*bishop.current_position(), Point::new(3, 3), Vector::Diagonal(DiagonalVector::TopRight), *bishop.id()),
            &Segment::Attack(*bishop.current_position(), Point::new(3, 1), Vector::Diagonal(DiagonalVector::BottomRight), *bishop.id()),
            &Segment::Attack(*bishop.current_position(), Point::new(1, 3), Vector::Diagonal(DiagonalVector::TopLeft), *bishop.id()),
        ],
    );
    ...
    fn it_describes_them_as_a_dead_end() {
        ...
        compare_and_assert(
            &board
                ...
                .to_vec(),
            &vec![
                &Segment::DeadEndAttack(*bishop.current_position(), Point::new(2, 2), Vector::Diagonal(DiagonalVector::BottomLeft), *bishop.id()),
                &Segment::DeadEndAttack(*bishop.current_position(), Point::new(4, 4), Vector::Diagonal(DiagonalVector::TopRight), *bishop.id()),
                &Segment::Attack(*bishop.current_position(), Point::new(5, 1), Vector::Diagonal(DiagonalVector::BottomRight), *bishop.id()),
                &Segment::Attack(*bishop.current_position(), Point::new(1, 5), Vector::Diagonal(DiagonalVector::TopLeft), *bishop.id()),
            ],
        );
