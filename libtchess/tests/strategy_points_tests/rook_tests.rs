...
fn when_there_are_no_pieces_around() {
    ...
    let rook = add_piece(&mut board,"Rook", Color::White, vec![], vec![], Point::new(3, 3));
...
fn when_there_is_a_an_enemy_piece_on_an_attack_point() {
    ...
    let config = board_config(dimension, TestSquaresMap::from_dimension(&dimension));
    let mut board = Board::empty(config);
    let rook = add_piece(&mut board,"Rook", Color::White, vec![], vec![], Point::new(2, 2));
    add_piece(&mut board,"Bishop", Color::Black, vec![], vec![], Point::new(3, 2));
...
fn when_there_is_a_an_enemy_king_on_the_way() {
    ...
    let config = board_config(dimension, TestSquaresMap::from_dimension(&dimension));
    let mut board = Board::empty(config);
    let rook = add_piece(&mut board,"Rook", Color::White, vec![], vec![], Point::new(1, 1));
    add_piece(&mut board,"King", Color::Black, vec![], vec![], Point::new(2, 1));
...
fn when_there_is_an_ally_piece_on_an_attack_point() {
    ...
    let mut board = Board::empty(config);
    let rook = add_piece(&mut board,"Rook", Color::White, vec![], vec![], Point::new(2, 2));
    add_piece(&mut board,"Bishop", Color::White, vec![], vec![], Point::new(3, 2));
...
fn when_there_is_an_ally_piece_between_the_rook_and_an_enemy_piece() {
    ...
    add_piece(&mut board,"Bishop", Color::White, vec![], vec![], Point::new(2, 1));
    add_piece(&mut board,"Bishop", Color::Black, vec![], vec![], Point::new(3, 1));
...
fn when_there_is_an_enemy_piece_between_the_rook_and_another_enemy_piece() {
    ...
    add_piece(&mut board,"Bishop", Color::Black, vec![], vec![], Point::new(2, 1));
    add_piece(&mut board,"Bishop", Color::Black, vec![], vec![], Point::new(3, 1));
